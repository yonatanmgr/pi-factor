...
const VirtualizedCommand = ({
    ...
    return (
        <Command shouldFilter={false} onKeyDown={handleKeyDown}>
            <CommandInput dir={"rtl"} onValueChange={handleSearch} placeholder={placeholder}/>
            <CommandList
                ref={parentRef}
                style={{
                    height: height,
                    ...
                    >
                        {virtualOptions.map((virtualOption) => (
                            ...
                            >
                                ...
                                />
                                <span className={"min-w-full truncate"}>{filteredOptions[virtualOption.index].label}</span>
                            </CommandItem>
                        ))}
                    </div>
                </CommandGroup>
    ...
    return (
        <Popover open={open} onOpenChange={setOpen}>
            <PopoverTrigger asChild>
                ...
                >
                    {isLoading ? "טוען קורסים..." : selectedOption ? options.find((option) => option === selectedOption) : searchPlaceholder}
            ...
            <PopoverContent className="p-0 w-full" >
                <VirtualizedCommand
                    ...
                    placeholder={isLoading ? "טוען קורסים..." : searchPlaceholder}
